            ...
            series : [
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[1200, 1320, 1010, 1340, 900, 2300, 2100,2300,2450,2560,2780,3000],
                    itemStyle: {
                        normal: {
                            color:"#1afffd"
                        }
            ...
            series : [
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[1020, 1032, 1010, 1304, 900, 2030, 2100,2530,2405,2756,2978,1560],
                    itemStyle: {
                        normal: {
                            color:"#45c0ff"
                        }
                ...
                },
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[2600, 3802, 2901, 1304, 2010, 3030, 3012,2039,2042,3944,2478,3856],
                    itemStyle: {
                        normal: {
                            color:"#0ad5ff"
                        }
                ...
                },
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[293, 1082, 2591, 234, 2090, 3049, 3100,2300,2045,2656,778,789],
                    itemStyle: {
                        normal: {
                            color:"#005ea1"
                        }
                ...
                },
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[3200, 3082, 2691, 434, 2490, 3460,2490,2302,2015,1956,2878,1969],
                    itemStyle: {
                        normal: {
                            color:"#ffcb89"
                        }
                ...
                },
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[2200, 1812, 3291, 3334, 2190, 3430, 2610,2130,1145,2056,1678,1100],
                    itemStyle: {
                        normal: {
                            color:"#2e7cff"
                        }
                ...
                },
                {
                    ...
                    type:'line',
                    stack: '人',
                    data:[220, 182, 191, 234, 290, 330, 310,230,1045,856,278,600],
                    itemStyle: {
                        normal: {
                            color:"#1afffd"
                        }
    ...
    $(function(){
        ...
        var option = {
            ...
            xAxis : [
                {
                    type : 'category',
                    data : ['Aaron亚伦', 'Bruce布鲁斯', 'Caspar卡斯帕', 'Denny丹尼', 'Geoffrey杰弗里 ', 'Jimmy吉米','Leopold利奥波特'],
                    splitLine: {
                        show: false
                    },
                    axisLabel: {
            ...
            series : [
                {
                    name:'访问次数（次）',
                    type:'bar',
                    data:[50, 70, 40, 10, 20, 90, 60,50,70],
                    itemStyle:{
                        normal:{
                            color:"#1afffd"
                        }
                ...
                },
                {
                    ...
                    type:'bar',
                    stack: '广告',
                    data:[20, 10, 40, 90, 70, 50, 20,70,60],
                    itemStyle:{
                        normal:{
                            color:"#2e7cff"
                        }
